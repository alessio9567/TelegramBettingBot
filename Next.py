...
def execute(country,league,competition_cod,N):
    ...
    try:
        ...
        Utility.telegram_bot_sendlog( "\U0000274C \U0000274C \U0000274C \U0000274C \U0000274C \n \
Attenzione: Errore ETL Fixtures \n \
Ambiente di {}  \n \
Competizione: {} \n \
Tipo di errore: Index Error \n \
Forse non sono presenti match in arrivo per questa competizione".format( ENV, Utility.decode_emoji(competition_cod) ))
        return 1
